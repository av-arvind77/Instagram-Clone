...
import com.yellowseed.databinding.FragmentMeNotificationBinding;
...
public class MeNotificationFragment extends BaseFragment {
    private Context context;
    private FragmentMeNotificationBinding binding;
  ...
  //  private ArrayList<ApiNotificationResonse.NotificationsBean> models;
    ...
    String text = "<b>Tim</b></font> <font color=#70696b>liked your</font>  <font color=#70696b>post.</font>";
    String text2 = "<b>Anurag</b></font> <font color=#70696b>commented on your</font> <font color=#70696b>post.</font>";
    String text3= "<b>Anurag</b></font> <font color=#70696b>tagged you in a post.</font> ";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_me_notification, container, false);
        ...
        /*if(CommonUtils.isOnline(context)) {
            callMyNotificationAPI(currentPage);
        }
        else
        {
...
*/
    ...
    public void initializedControl() {
        binding.rvMeNotification.setHasFixedSize(true);
        final LinearLayoutManager layoutManager = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);
//        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(context);
        binding.rvMeNotification.setLayoutManager(layoutManager);
...
/*        DividerItemDecoration itemDecorator = new DividerItemDecoration(context, DividerItemDecoration.VERTICAL);
        ...
        binding.rvMeNotification.addItemDecoration(itemDecorator);*/
        models = new ArrayList<>();

      /*  notificationLayoutAdapter = new NotificationLayoutAdapter(models, context, MeNotificationFragment.class.getSimpleName(), new RecyclerItemClickListener.OnItemClickListener() {
            @Override
        ...
        binding.rvMeNotification.setAdapter(notificationLayoutAdapter);


        binding.rvMeNotification.addOnScrollListener(new RecyclerView.OnScrollListener() {
...
*/
     ...
     */
  /*  private void callMyNotificationAPI(final int pageNo) {
        if(CommonUtils.isOnline(context)) {
            ...
            Call<ApiNotificationResonse> call = ApiExecutor.getClient(context).apiCallMyNotification(jsonObject);
