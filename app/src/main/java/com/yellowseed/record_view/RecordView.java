...
public class RecordView extends RelativeLayout{
    ...
    public void setRecordViewResultListner(RecordViewResultListner recordViewResultListner) {
        this.recordViewResultListner = recordViewResultListner;
    }

    private RecordViewResultListner recordViewResultListner;
    ...
    protected void onActionUp(RecordButton recordBtn) {
        ...
        if (!isLessThanSecondAllowed && isLessThanOneSecond(elapsedTime) && !isSwiped) {
            ...
            recordViewResultListner.onResult(false);
            ...
            if (!isSwiped) {
                ...
                recordViewResultListner.onResult(true);
            }else{
                recordViewResultListner.onResult(false);
            }
