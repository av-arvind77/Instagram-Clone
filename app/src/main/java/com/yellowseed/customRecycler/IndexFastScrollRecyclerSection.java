package com.yellowseed.customRecycler;
        ...
        if (setIndexBarVisibility) {
            ...
            if (mSections != null && mSections.length > 0) {
                ...
                for (int i = 0; i < mSections.length; i++) {
                    ...
                    float radius = setIndexTextSize / 2;
                    if (setSetIndexBarHighLateTextVisibility) {
                        ...
                        float v = mIndexbarRect.top + mIndexbarMargin + sectionHeight * i + paddingTop - indexPaint.ascent();
                        float cy = ((mIndexbarRect.top + mIndexbarMargin + sectionHeight * (i + 1) + paddingTop - indexPaint.ascent())
                                - v) / 2;
                       ...
                       /* Bitmap cameraBitmap = BitmapFactory.decodeByteArray(bytes,0,bytes.length, opt);
                        ...
                        Drawable d = ContextCompat.getDrawable(context, R.drawable.myDrawable);
                        //Centre the drawing
                        ...
                        canvas.drawText(mSections[i], mIndexbarRect.left + paddingLeft
                                , v, indexPaint);
                        canvas.drawCircle((mIndexbarRect.left + mIndexbarWidth / 2)
                                , v + cy - radius*1.5f, radius, indexPaint);
                    }
