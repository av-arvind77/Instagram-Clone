package com.quickblox.sample.video.fragments;
...
//        QBUser participant = dbManager.getUserById(Integer.parseInt(CollectionsUtils.makeStringFromUsersFullNames(opponents)));
//        final String participantName = userOtherName != null ? participant.getFullName() : String.valueOf(CollectionsUtils.makeStringFromUsersFullNames(opponents));





        //allOpponentsTextView.setText(CallActivity.userOtherName);
      ...
      /*  micToggleVideoCall.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        ...
        micToggleVideoCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!isMute){
                    isMute=true;
                    conversationFragmentCallbackListener.onSetAudioEnabled(isMute);
                }else {
                    isMute=false;
                }
